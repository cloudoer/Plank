...
- (void)updateDisplay {
    ...
    if (self.countDirection == kCountDirectionDown && _value < 50 && self.isRunning) {
        [self stop];
        self.valueString = self.displayMode == kDisplayModeFull ? @"00.00" : @"00";
...
//    __weak typeof(self) weakSelf = self;
    ...
    if (self.refreshP) {
        self.refreshP(self.currentValue);        
    }
...
- (NSString *)timeFormattedStringForValue:(unsigned long long)value {
    ...
    if (hrs == 0) {
//        if (mins == 0) {
//            formattedString = self.displayMode == kDisplayModeFull ? [NSString stringWithFormat:@"%02llu.%02llu", secs, frac] : [NSString stringWithFormat:@"%02llu", secs];
//        } else {
            formattedString = self.displayMode == kDisplayModeFull ? [NSString stringWithFormat:@"%02llu:%02llu.%02llu", mins, secs, frac] : [NSString stringWithFormat:@"%02llu:%02llu", mins, secs];
//        }
    } else {
